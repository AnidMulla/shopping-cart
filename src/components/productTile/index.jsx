...
function ProductTile({ singleProduct }) {
  ...
  function handleNavigateToProductDetailsPage(getCurrentId) {
    navigate(`/product-details/${getCurrentId}`);
  }
  return (
    <div className="relative group border-cyan-700 p-6 cursor-pointer">
      ...
      <button
        ...
        className="px-5 mt-5 w-full py-2 rounded-none text-white font-bold bg-black"
      >
        View Details
      </button>
    </div>
